...
To perform the code review, you must execute a sequential 10-pass review workflow. In the JSON "thinking" field, document your concise findings for each of the following 10 passes in order:
...
- **Pass 10: PII Detection**: Scan for personally identifiable information including:
  - Email addresses (personal, corporate, or internal patterns)
  - Full names or usernames that could identify individuals
  - Hardcoded home directory paths (e.g., /Users/username, /home/username)
  - Credentials, API keys, tokens, SSH keys, or private key material
  - IP addresses, hostnames, or MAC addresses
  - Phone numbers, physical addresses, or government IDs
  Context-aware: distinguish real PII from placeholder/example values (e.g., "your.email@example.com").

Synthesize your overall findings from these 10 passes in the 'summary' field using the following format:
## Code Review Summary
